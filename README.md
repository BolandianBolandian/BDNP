...
##### Attention:
To compare the amount of changes in the USD/IRR market compared to the Iranian stock market, if the total index of the Iranian stock market is used to compare with USD/IRR rate, we will not get the correct result because, for several reasons, the total index of the Iranian stock market does not represent the real state of the entire stocks in the market and deliberate manipulations by the market maker is evident in this index in different time frames.
Therefore, in order to more closely examine the overall changes in the Iranian stock market, we have used the average changes of 4 stock investment funds named Dariush, Kardan, Agas and Asas. I named this as SIF index (Stock Investment Funds index).
